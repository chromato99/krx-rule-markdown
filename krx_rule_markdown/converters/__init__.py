...
def __getattr__(name: str):
    # core imports quality to attach diagnostics. Keep these two public
    # compatibility exports lazy so quality can import converters.inspection
    # without re-entering a partially initialized quality module.
    if name in {"convert_attachment", "convert_bytes"}:
        from .core import convert_attachment, convert_bytes

        return {"convert_attachment": convert_attachment, "convert_bytes": convert_bytes}[name]
